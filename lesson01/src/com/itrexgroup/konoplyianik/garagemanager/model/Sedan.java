...
public class Sedan extends Car {
	...
	public Sedan(String brand, String model, String manufactureYear, String color, double maxSpeed, double cost, boolean neBitaNeKrashena) {
	...
	public String toString() {
		return this.getClass().getSimpleName() + "[" + brand + "  " + model + " " + manufactureYear + " year of manufacture,"
				+ color + " color, maxSpeed=" + maxSpeed + ", cost= $" + cost
